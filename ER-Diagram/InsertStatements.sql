...
insert into questions values( 1, "This is 1st question on java by user 1.", 1, 2);
insert into questions values( 2, "This is 1st question on graphs by user 2.", 2, 1);
insert into questions values( 3, "This is question on graphs by user 3.", 3, 1);
insert into questions values( 4, "This is question on greedy by user 2.", 2, 3);
...
insert into comments values( 1, "This is a comment on graphs by user 1.", 1, 2);
insert into comments values( 2, "This is a comment on java by user 2.", 2, 1);
insert into comments values( 3, "This is a comment on graphs by user 3.", 3, 2);
insert into comments values( 4, "This is a comment on greedy by user 2.", 2, 3);
